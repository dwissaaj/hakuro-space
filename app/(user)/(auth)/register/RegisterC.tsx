  ...
  return (
    <div className="p-4 mt:2 w-full flex flex-col items-center gap-4 justify-center">
      <div className="text-center ">
        ...
        <p>
          To prevent stealing content you need an Account see my Data
          Visualization, Graphic Design, and UI/UX. If you dont want this please
          email me.
        </p>
      </div>
      <div className="max-w-sm w-full md:w-1/2 p-8 border-2 border-primary-500 rounded-lg shadow-lg shadow-secondary-400">
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            <Link
              className="hover:text-secondary-500 hover:underline"
              href="/login"
            >
              {" "}
              Login Here

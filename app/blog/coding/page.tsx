...
export default function page() {
  return (
    <div className='w-screen font-raleway mt-8 flex items-center justify-center'>
      ...
      <p className='text-white uppercase text-center text-xl w-full bg-red-500'>Still on Development!!!</p>
        ...
        <CodingCardSoon subtitle='Which one to choose?' buttonTitle='Soon' style='col-span-12 lg:col-span-4 h-[300px] text-black' source='/blog/coding/coding.jpg' altImg='coding pics'

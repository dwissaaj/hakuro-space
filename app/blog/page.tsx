      ...
      <div className='w-full p-2  flex flex-col items-center justify-center '>
        ...
        <div className=''>
          ...
          <div className='w-full grid grid-cols-12 gap-4 p-2'>
            <BlogCardReady link='/blog/coding' src='/blog/coding.jpg' imageAlt='Coding Image' headline='CODING' caption='Not a CS graduate but I love this.' />
            <BlogCardReady caption='Artistic side of me.' headline='PHOTOGRAPHY' link='/blog/photography' src='/blog/photography.jpg' imageAlt='Camera' />

...
export default function CardBlog({
  ...
  return (
    <Card
      isHoverable
      className={`${cardStyle} border-2 border-white/50 shadow-[-7px_6px_30px_-5px_rgba(255,255,255,0.3)] bg-black/80  `}
    >
      <CardHeader className="max-h-12 my-2">
        <p className=" text-lg lg:text-3xl text-white/80 underline">
          {headline}
        </p>
      </CardHeader>
